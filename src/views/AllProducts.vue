...
const STATIC_PRODUCTS: Product[] = [
    ...
    { id: 48, brand: 'Amtico', title: 'Spacia', productDescription: 'Spacia is a very nice product.', applications: ['Common & high traffic areas', 'Kitchens & bathrooms'], materials: ['Vinyl'], patterns: ['Timber effect'], shades: ['Neutral'], features: ['Durable', 'Compliant'], price: '$$', env: ['Declare'], shapes: ['Planks'], image: '/brand/amtico/products/spacia/spacia.webp' },
    { id: 49, brand: 'Amtico', title: 'Signature', productDescription: 'Signature is a very nice product.', applications: ['Entrance', 'Service areas'], materials: ['Vinyl'], patterns: ['Geometric'], shades: ['Light'], features: ['Recycled Content', 'Green Certificate'], price: '$$$', env: ['GreenTag'], shapes: ['Planks'], image: '/brand/amtico/products/signature/signature.webp' },
    { id: 50, brand: 'Amtico', title: 'Form', productDescription: 'Form is a very nice product.', applications: ['Common & high traffic areas', 'Healthcare areas'], materials: ['Vinyl'], patterns: ['Solid'], shades: ['Neutral'], features: ['Durable', 'Lifetime Warranty'], price: '$$$', env: ['Declare'], shapes: ['Planks'], image: '/brand/amtico/products/form/form.webp' },
    { id: 51, brand: 'Amtico', title: 'Decor', productDescription: 'Decor is a very nice product.', applications: ['Entrance', 'Stairways'], materials: ['Vinyl'], patterns: ['Geometric'], shades: ['Bright'], features: ['Quick Ship', 'Compliant'], price: '$$', env: ['GreenTag'], shapes: ['Hexagons'], image: '/brand/amtico/products/decor/decor.webp' },
    { id: 52, brand: 'Amtico', title: 'Access', productDescription: 'Access is a very nice product.', applications: ['Common & high traffic areas', 'Service areas'], materials: ['Vinyl'], patterns: ['Linear'], shades: ['Dark'], features: ['Durable', 'Recyclable'], price: '$', env: ['Declare'], shapes: ['Planks'], image: '/brand/amtico/products/access/access.webp' },
    { id: 53, brand: 'Amtico', title: 'Click Smart', productDescription: 'Click Smart is a very nice product.', applications: ['Entrance', 'Kitchens & bathrooms'], materials: ['Vinyl'], patterns: ['Timber effect'], shades: ['Neutral'], features: ['Recycled Content', 'Green Certificate'], price: '$$', env: ['GreenTag'], shapes: ['Planks'], image: '/brand/amtico/products/clicksmart/clicksmart.webp' },
    { id: 54, brand: 'Amtico', title: 'Marine', productDescription: 'Marine is a very nice product.', applications: ['Service areas', 'Stairways'], materials: ['Vinyl'], patterns: ['Solid'], shades: ['Light'], features: ['Durable', 'Compliant'], price: '$$', env: ['Declare'], shapes: ['Planks'], image: '/brand/amtico/products/marine/marine.webp' },
    { id: 55, brand: 'Amtico', title: 'First', productDescription: 'First is a very nice product.', applications: ['Entrance', 'Common & high traffic areas'], materials: ['Vinyl'], patterns: ['Solid'], shades: ['Neutral'], features: ['Durable', 'Recyclable'], price: '$$', env: ['Declare'], shapes: ['Planks'], image: '/brand/amtico/products/first/first.webp' },

    { id: 56, brand: 'Unitile', title: 'USF 800 EB', productDescription: 'USF 800 EB is a very nice product.', applications: ['Entrance', 'Common & high traffic areas'], materials: ['Aluminium', 'Rubber'], patterns: ['Linear'], shades: ['Neutral'], features: ['Durable', 'Compliant'], price: '$$', env: ['GreenTag'], shapes: ['Rolls'], image: '/brand/unitile/unitile.jpeg' },
    { id: 57, brand: 'Unitile', title: 'UNIFOLD 1650', productDescription: 'UNIFOLD 1650 is a very nice product.', applications: ['Entrance', 'Service areas'], materials: ['Aluminium', 'Rubber'], patterns: ['Geometric'], shades: ['Dark'], features: ['Durable', 'Recyclable'], price: '$$', env: ['Declare'], shapes: ['Rolls'], image: '/brand/unitile/unifold-1650.jpeg' },
    ...
    { id: 63, brand: 'Modulyss', title: 'In-Stock Modulyss', productDescription: 'Modulyss Products which are in stock.', applications: ['Entrance', 'Common & high traffic areas'], materials: ['Carpet'], patterns: ['Textured'], shades: ['Neutral'], features: ['Durable', 'Recyclable'], price: '$$', env: ['GreenTag'], shapes: ['Squares'], image: '/brand/modulyss/products/dsgntweed.webp', inStockTotal: 18 },
    { id: 64, brand: 'Amtico', title: 'In-Stock Amtico', productDescription: 'Amtico Products which are in stock.', applications: ['Service areas', 'Stairways'], materials: ['Vinyl'], patterns: ['Solid'], shades: ['Light'], features: ['Durable', 'Compliant'], price: '$$', env: ['Declare'], shapes: ['Planks'], image: '/brand/amtico/products/form/form.webp', inStockTotal: 8 },
    { id: 65, brand: 'Unitile', title: 'In-Stock Unitile', productDescription: 'Unitile Products which are in stock.', applications: ['Stairways', 'Entrance'], materials: ['Rubber'], patterns: ['Linear'], shades: ['Dark'], features: ['Durable', 'Recyclable'], price: '$$', env: ['GreenTag'], shapes: ['Rolls'], image: '/brand/unitile/unitile.jpeg', inStockTotal: 1 },
