...
type Brand = 'Modulyss' | 'Amtico' | 'Unitile'
...
const STATIC_PRODUCTS: Product[] = [
    ...
    { id: 28, brand: 'Modulyss', title: 'Meadow', productDescription: 'Meadow is a very nice product.', applications: ['Common & high traffic areas', 'Sports'], materials: ['Carpet'], patterns: ['Organic'], shades: ['Bright'], features: ['Durable', 'NZ stock'], price: '$$', env: ['Declare'], shapes: ['Squares'], image: '/brand/modulyss/products/meadow.webp' },
    { id: 29, brand: 'Modulyss', title: 'Mezzo', productDescription: 'Mezzo is a very nice product.', applications: ['Entrance', 'Service areas'], materials: ['Carpet'], patterns: ['Textured'], shades: ['Neutral'], features: ['Quick Ship', 'Green Certificate'], price: '$', env: ['GreenTag'], shapes: ['Squares'], image: '/brand/modulyss/products/mezzo.webp' },
    { id: 30, brand: 'Modulyss', title: 'Millennium Nxtgen', productDescription: 'Millennium Nxtgen is a very nice product.', applications: ['Common & high traffic areas', 'Healthcare areas'], materials: ['Carpet'], patterns: ['Solid'], shades: ['Dark'], features: ['Durable', 'Lifetime Warranty'], price: '$$$', env: ['Declare'], shapes: ['Squares'], image: '/brand/modulyss/products/millenium.webp' },
    { id: 31, brand: 'Modulyss', title: 'Monos', productDescription: 'Monos is a very nice product.', applications: ['Entrance', 'Kitchens & bathrooms'], materials: ['Carpet'], patterns: ['Solid'], shades: ['Neutral'], features: ['Recycled Content', 'Recyclable'], price: '$', env: ['GreenTag'], shapes: ['Squares'], image: '/brand/modulyss/products/monos.webp' },
    { id: 32, brand: 'Modulyss', title: 'Moss', productDescription: 'Moss is a very nice product.', applications: ['Common & high traffic areas', 'Service areas'], materials: ['Carpet'], patterns: ['Organic'], shades: ['Light'], features: ['Durable', 'Compliant'], price: '$$', env: ['Declare'], shapes: ['Squares'], image: '/brand/modulyss/products/moss.webp' },
    { id: 33, brand: 'Modulyss', title: 'Motion', productDescription: 'Motion is a very nice product.', applications: ['Entrance', 'Stairways'], materials: ['Carpet'], patterns: ['Linear'], shades: ['Neutral'], features: ['Quick Ship', 'NZ stock'], price: '$$', env: ['GreenTag'], shapes: ['Squares'], image: '/brand/modulyss/products/motion.webp' },
    { id: 34, brand: 'Modulyss', title: 'Patchwork', productDescription: 'Patchwork is a very nice product.', applications: ['Common & high traffic areas', 'Sports'], materials: ['Carpet'], patterns: ['Geometric'], shades: ['Bright'], features: ['Durable', 'Green Certificate'], price: '$', env: ['Declare'], shapes: ['Squares'], image: '/brand/modulyss/products/patchwork.webp' },
    { id: 35, brand: 'Modulyss', title: 'Pattern', productDescription: 'Pattern is a very nice product.', applications: ['Entrance', 'Service areas'], materials: ['Carpet'], patterns: ['Geometric'], shades: ['Neutral'], features: ['Recycled Content', 'Recyclable'], price: '$$', env: ['GreenTag'], shapes: ['Squares'], image: '/brand/modulyss/products/pattern.webp' },
    { id: 36, brand: 'Modulyss', title: 'Pixel', productDescription: 'Pixel is a very nice product.', applications: ['Common & high traffic areas', 'Healthcare areas'], materials: ['Carpet'], patterns: ['Geometric'], shades: ['Light'], features: ['Durable', 'Compliant'], price: '$$$', env: ['Declare'], shapes: ['Squares'], image: '/brand/modulyss/products/pixel.webp' },
    { id: 37, brand: 'Modulyss', title: 'Polder', productDescription: 'Polder is a very nice product.', applications: ['Entrance', 'Kitchens & bathrooms'], materials: ['Carpet'], patterns: ['Organic'], shades: ['Dark'], features: ['Quick Ship', 'Green Certificate'], price: '$', env: ['GreenTag'], shapes: ['Squares'], image: '/brand/modulyss/products/polder.webp' },
    { id: 38, brand: 'Modulyss', title: 'Rocket', productDescription: 'Rocket is a very nice product.', applications: ['Common & high traffic areas', 'Service areas'], materials: ['Carpet'], patterns: ['Geometric'], shades: ['Neutral'], features: ['Durable', 'Recyclable'], price: '$$', env: ['Declare'], shapes: ['Squares'], image: '/brand/modulyss/products/rocket.webp' },
    { id: 39, brand: 'Modulyss', title: 'Rust', productDescription: 'Rust is a very nice product.', applications: ['Entrance', 'Stairways'], materials: ['Carpet'], patterns: ['Textured'], shades: ['Dark'], features: ['Recycled Content', 'Compliant'], price: '$$', env: ['GreenTag'], shapes: ['Squares'], image: '/brand/modulyss/products/rust.webp' },
    { id: 40, brand: 'Modulyss', title: 'Spark', productDescription: 'Spark is a very nice product.', applications: ['Common & high traffic areas', 'Sports'], materials: ['Carpet'], patterns: ['Solid'], shades: ['Bright'], features: ['Durable', 'NZ stock'], price: '$$$', env: ['Declare'], shapes: ['Squares'], image: '/brand/modulyss/products/spark.webp' },
    { id: 41, brand: 'Modulyss', title: 'Textura', productDescription: 'Textura is a very nice product.', applications: ['Entrance', 'Service areas'], materials: ['Carpet'], patterns: ['Textured'], shades: ['Neutral'], features: ['Quick Ship', 'Green Certificate'], price: '$', env: ['GreenTag'], shapes: ['Squares'], image: '/brand/modulyss/products/textura.webp' },
    { id: 42, brand: 'Modulyss', title: 'Trace', productDescription: 'Trace is a very nice product.', applications: ['Common & high traffic areas', 'Healthcare areas'], materials: ['Carpet'], patterns: ['Linear'], shades: ['Light'], features: ['Durable', 'Recyclable'], price: '$$', env: ['Declare'], shapes: ['Squares'], image: '/brand/modulyss/products/trace.webp' },
    { id: 43, brand: 'Modulyss', title: 'Velvet&', productDescription: 'Velvet& is a very nice product.', applications: ['Entrance', 'Kitchens & bathrooms'], materials: ['Carpet'], patterns: ['Solid'], shades: ['Neutral'], features: ['Recycled Content', 'Compliant'], price: '$$', env: ['GreenTag'], shapes: ['Squares'], image: '/brand/modulyss/products/velvet.webp' },
    { id: 44, brand: 'Modulyss', title: 'Vision', productDescription: 'Vision is a very nice product.', applications: ['Common & high traffic areas', 'Service areas'], materials: ['Carpet'], patterns: ['Geometric'], shades: ['Light'], features: ['Durable', 'Green Certificate'], price: '$$$', env: ['Declare'], shapes: ['Squares'], image: '/brand/modulyss/products/vision.webp' },
    { id: 45, brand: 'Modulyss', title: 'Willow', productDescription: 'Willow is a very nice product.', applications: ['Entrance', 'Stairways'], materials: ['Carpet'], patterns: ['Organic'], shades: ['Dark'], features: ['Quick Ship', 'Recyclable'], price: '$', env: ['GreenTag'], shapes: ['Squares'], image: '/brand/modulyss/products/willow.webp' },

    { id: 46, brand: 'Amtico', title: 'Spacia', productDescription: 'Spacia is a very nice product.', applications: ['Common & high traffic areas', 'Kitchens & bathrooms'], materials: ['Vinyl'], patterns: ['Timber effect'], shades: ['Neutral'], features: ['Durable', 'Compliant'], price: '$$', env: ['Declare'], shapes: ['Planks'], image: '/brand/modulyss/products/artus.webp' },
    { id: 47, brand: 'Amtico', title: 'Signature', productDescription: 'Signature is a very nice product.', applications: ['Entrance', 'Service areas'], materials: ['Vinyl'], patterns: ['Geometric'], shades: ['Light'], features: ['Recycled Content', 'Green Certificate'], price: '$$$', env: ['GreenTag'], shapes: ['Planks'], image: '/brand/modulyss/products/artus.webp' },
    { id: 48, brand: 'Amtico', title: 'Form', productDescription: 'Form is a very nice product.', applications: ['Common & high traffic areas', 'Healthcare areas'], materials: ['Vinyl'], patterns: ['Solid'], shades: ['Neutral'], features: ['Durable', 'Lifetime Warranty'], price: '$$$', env: ['Declare'], shapes: ['Planks'], image: '/brand/modulyss/products/artus.webp' },
    { id: 49, brand: 'Amtico', title: 'Decor', productDescription: 'Decor is a very nice product.', applications: ['Entrance', 'Stairways'], materials: ['Vinyl'], patterns: ['Geometric'], shades: ['Bright'], features: ['Quick Ship', 'Compliant'], price: '$$', env: ['GreenTag'], shapes: ['Hexagons'], image: '/brand/modulyss/products/artus.webp' },
    { id: 50, brand: 'Amtico', title: 'Access', productDescription: 'Access is a very nice product.', applications: ['Common & high traffic areas', 'Service areas'], materials: ['Vinyl'], patterns: ['Linear'], shades: ['Dark'], features: ['Durable', 'Recyclable'], price: '$', env: ['Declare'], shapes: ['Planks'], image: '/brand/modulyss/products/artus.webp' },
    { id: 51, brand: 'Amtico', title: 'Click Smart', productDescription: 'Click Smart is a very nice product.', applications: ['Entrance', 'Kitchens & bathrooms'], materials: ['Vinyl'], patterns: ['Timber effect'], shades: ['Neutral'], features: ['Recycled Content', 'Green Certificate'], price: '$$', env: ['GreenTag'], shapes: ['Planks'], image: '/brand/modulyss/products/artus.webp' },
    { id: 52, brand: 'Amtico', title: 'Marine', productDescription: 'Marine is a very nice product.', applications: ['Service areas', 'Stairways'], materials: ['Vinyl'], patterns: ['Solid'], shades: ['Light'], features: ['Durable', 'Compliant'], price: '$$', env: ['Declare'], shapes: ['Planks'], image: '/brand/modulyss/products/artus.webp' },

    { id: 53, brand: 'Unitile', title: 'Prolattice', productDescription: 'Prolattice is a very nice product.', applications: ['Entrance', 'Common & high traffic areas'], materials: ['Aluminium', 'Rubber'], patterns: ['Geometric'], shades: ['Neutral'], features: ['Compliant', 'Recyclable'], price: '$$', env: ['GreenTag'], shapes: ['Rolls'], image: '/brand/modulyss/products/artus.webp' },
